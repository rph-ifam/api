...
public class ClientController {
  ...
  @PostMapping(value = "/validarCliente/{nome}/{cpf}")
  public ClientDto validateClient(@Valid @PathVariable String nome, @PathVariable String cpf) {
    return clientService.validateClient(nome, cpf);
  }
